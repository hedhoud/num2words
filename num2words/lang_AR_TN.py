...
CURRENCY_TN = [("دينار", "دينارين", "دينارات", "دينار"),
                ("فرنك", "ميتين", "فرنك", "فرنك")]
ARABIC_ONES = [
    "", "واحد", "ثنين", "ثلاث", "أربع", "خمس", "ستة", "سبع", "ثمني",
    "تسع",
    "عشرا", "حداش", "أثناش", "ثلطاش", "اربعطاش", "خمسطاش",
    "سطاش", "سبعطاش", "ثمنطاش",
    "تسعطاش"
]


class Num2Word_AR_TN(Num2Word_Base):
    ...
    def __init__(self):
        ...
        self.currency_unit = CURRENCY_TN[0]
        self.currency_subunit = CURRENCY_TN[1]
        ...
        self.arabicFeminineOnes = [
            "", "واحد", "ثنين", "ثلاثة", "أربعة", "خمسة", "ستة", "سبعة", "ثمنية",
            "تسعة",
            "عشرا", "حداش", "أثناش", "ثلطاش", "اربعطاش", "خمسطاش",
            "سطاش", "سبعطاش", "ثمنطاش",
            "تسعطاش"
        ...
        self.arabicOrdinal = [
            "", "اللول", "ثاني", "ثالث", "رابع", "خامس", "سادس", "سابع", "ثامن",
            "التاسع", "العاشر", "الحداش", "الاثناش", "الثلطاش", "الاربعطاش",
            "الخمسطاش", "السطاش", "السبعطاش", "الثمنطاش", "التسعطاش"
        ]
        self.arabicTens = [
            "عشرين", "ثلاثين", "أربعين", "خمسين", "ستين", "سبعين", "ثمانين",
            "تسعين"
        ]
        self.arabicHundreds = [
            "", "مياة", "ميتين", "ثلاثمياة", "أربعمياة", "خمسمياة", "ستمياة",
            "سبعمياة", "ثمانمياة", "تسعمياة"
        ]

        self.arabicAppendedTwos = [
            "ميتين", "ألفين", "مليونين", "ملييرين", "تريليونين",
            "كوادريليونين", "كوينتليونين", "سكستيليونين", "سبتيليونين",
            "أوكتيليونين ", "نونيليونين ", "ديسيليونين", "أندسيليونين",
            "دوديسيليونين", "تريديسيليونين", "كوادريسيليونين", "كوينتينيليونين"
        ]
        self.arabicTwos = [
            "ميتين", "ألفين", "مليونين", "ملييرين", "تريليونين",
            "كوادريليونين", "كوينتليونين", "سكستيليونين", "سبتيليونين",
        ...
        self.arabicGroup = [
            "مياه", "ألف", "مليون", "مليار", "تريليون", "كوادريليون",
    ...
    def set_currency_prefer(self):
        self.currency_unit = CURRENCY_TN[0]
        self.currency_subunit = CURRENCY_TN[1]

    def to_currency(self, value, prefix='', suffix=''):
        self.set_currency_prefer()
        self.isCurrencyNameFeminine = False
        self.separator = "و"
        self.arabicOnes = ARABIC_ONES
